...
namespace TheSanity.GlobalNPC.Bosses.WhiteWhale
{
    ...
    public class WhiteWhaleBoss : ModNPC
    {
        ...
        public enum P2Attacks {
            ...
            Dash_Letter_A,
            Dash_Letter_Z,
            Dash_Letter_T, // Ditambahkan
            Dash_Letter_N, // Ditambahkan
            Dash_Letter_H, // Ditambahkan
        ...
        // Method Pembantu Baru untuk Mengacak Pola Serangan Fase 2
        private void ChooseNextP2Attack() {
            if (Main.netMode != NetmodeID.MultiplayerClient) {
                ...
                } while (nextAttack == (int)AttackState); // Menghindari serangan yang sama terulang berturut-turut
        ...
        private void UpdatePhase2(Player target) {
            ...
            switch ((P2Attacks)AttackState) {
                ...
                case P2Attacks.Dash_Letter_T: // Garis Horizontal Atas (Kiri ke Kanan)
                    if (AttackTimer <= 50) {
                        Vector2 readyPos = target.Center + new Vector2(-600f, -400f);
                        NPC.velocity = Vector2.Lerp(NPC.velocity, (readyPos - NPC.Center) * 0.15f, 0.1f);
                        dashTelegraphRotation = 0f; 
                ...
                case P2Attacks.Dash_Letter_N: // Garis Vertikal Kiri (Bawah ke Atas)
                    if (AttackTimer <= 50) {
                ...
                case P2Attacks.Dash_Letter_H: // Garis Vertikal Kiri (Atas ke Bawah)
                    if (AttackTimer <= 50) {
                        Vector2 readyPos = target.Center + new Vector2(-400f, -500f);
                        NPC.velocity = Vector2.Lerp(NPC.velocity, (readyPos - NPC.Center) * 0.15f, 0.1f);
                        dashTelegraphRotation = MathHelper.PiOver2; 
